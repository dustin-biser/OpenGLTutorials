...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/vertPositionOffset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertPositionOffset
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/vertPositionOffset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertPositionOffset
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking vertPositionOffset
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning vertPositionOffset
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
