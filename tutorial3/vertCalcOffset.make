...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/vertCalcOffset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertCalcOffset
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/vertCalcOffset
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertCalcOffset
