...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/vertCalcOffset_Remixed
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertCalcOffset_Remixed
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/vertCalcOffset_Remixed
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/vertCalcOffset_Remixed
...
OBJECTS := \
	$(OBJDIR)/vertCalcOffset_Remixed.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking vertCalcOffset_Remixed
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning vertCalcOffset_Remixed
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/vertCalcOffset_Remixed.o: vertCalcOffset_Remixed.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
