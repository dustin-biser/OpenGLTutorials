...
void InitializeProgram()
{
    ...
    glUniform1f(fragLoopDurUnf, 3.0f);
    glUseProgram(0);
}
...
void display()
{
    ...
    // Draw 10 triangles equally spaced out around a unit circle.
    for(unsigned int i = 0; i < gNumTriangles; ++i){
    	float angle = 5.0f / gNumTriangles;
		glUniform1f(elapsedTimeUniform, glutGet(GLUT_ELAPSED_TIME) / 1000.0f + (float)i*angle);
