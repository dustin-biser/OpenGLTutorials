...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/ShaderPersepective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ShaderPersepective
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/ShaderPersepective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ShaderPersepective
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking ShaderPersepective
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning ShaderPersepective
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ShaderPersepective.o: ShaderPersepective.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
