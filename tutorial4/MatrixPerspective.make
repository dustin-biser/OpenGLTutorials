...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/MatrixPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/MatrixPerspective
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/MatrixPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/MatrixPerspective
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking MatrixPerspective
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning MatrixPerspective
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
