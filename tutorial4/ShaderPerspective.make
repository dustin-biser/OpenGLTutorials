...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/ShaderPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ShaderPerspective
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/ShaderPerspective
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ShaderPerspective
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking ShaderPerspective
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning ShaderPerspective
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
